...
{
    /// <summary>Tela de exercícios de múltipla escolha pra praticar uma palavra já cadastrada no dicionário.</summary>
    public partial class ExerciciosPainel : UserControl
    {
        ...
        private void MostrarEtapa(FrameworkElement etapa)
        {
            ...
            // Volta pro topo da etapa com rolagem, senão a posição fica "lembrando" da etapa anterior.
