...
namespace WordByWord
{
    public partial class MainWindow : Window
    {
        ...
        private Palavra? _palavraSelecionada; // edição via formulário
        ...
        // Por padrão o app abre MAXIMIZADO. Tela cheia de verdade (sem bordas, F11) é opcional.
        ...
        /// <summary>Janela aparece  e some suavemente na tela.</summary>
        ...
        // Guarda a palavra digitada quando o overlay de duplicidade é aberto, pra concluir o cadastro depois.
        private Palavra? _palavraDuplicadaEncontrada;

        /// <summary>Usa a IA pra preencher Significado e Exemplo a partir da palavra digitada (usuário revisa antes de salvar).</summary>
        ...
        private void Adicionar_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Se não está editando, verifica se a palavra já existe no dicionário.
            if (!_editando)
            {
        ...
        // FORMULÁRIO DE PALAVRA — abre em tela cheia dentro da própria janela.
        ...
        // ASSISTENTE — painel embutido, troca de lugar com lista/detalhe/formulário.

        /// <summary>Esconde todas as telas de conteúdo, pra nunca deixar duas abertas ao mesmo tempo.</summary>
        ...
        /// <summary>Atalho no cabeçalho: abre o assistente já na conversa, sem passar pela configuração.</summary>
        ...
        /// <summary>Pede a pronúncia ao Edge TTS e toca; mostra erro se o edge-tts não estiver instalado.</summary>
        ...
        // Guarda a palavra a remover e o que fazer depois, já que o overlay não bloqueia a execução.
        private Palavra? _palavraParaRemover;
        private Action? _aoConfirmarRemocao;

        /// <summary>Pede confirmação antes de remover uma palavra; <paramref name="aoConfirmar"/> roda só se confirmado.</summary>
